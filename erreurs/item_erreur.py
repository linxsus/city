...
class ItemErreur(ListeActions.Item):
    ...
    def _detect_image(self):
        ...
        return self.fenetre.detect_image(image_path, threshold=self.threshold, region=self.region)
    ...
    def _exclure_fenetre(self):
        ...
        logger.info(
            f"Fenêtre {self.fenetre.fenetre_id} exclue pour {self.exclure_fenetre}s: {self.message}"
        )
