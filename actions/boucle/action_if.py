...
class ActionIf(Item):
    ...
    def __init__(self, fenetre, condition_func, actions_si_vrai):
        ...
        self.actions_si_vrai = actions_si_vrai if isinstance(actions_si_vrai, list) else [actions_si_vrai]
    ...
    def _run(self):
        ...
        self.logger.debug(
            f"ActionIf: {len(self.actions_si_vrai)} action(s) ajoutée(s)"
        )
        return True
...
class ActionIfElse(Item):
    ...
    def __init__(self, fenetre, condition_func, actions_si_vrai, actions_si_faux):
        ...
        super().__init__(fenetre, condition_func)
        self.actions_si_vrai = actions_si_vrai if isinstance(actions_si_vrai, list) else [actions_si_vrai]
        self.actions_si_faux = actions_si_faux if isinstance(actions_si_faux, list) else [actions_si_faux]
    ...
    def execute(self):
        ...
        self.logger.debug(
            f"ActionIfElse: branche {branche}, {len(actions)} action(s) ajoutée(s)"
        )
